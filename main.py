...
# 💡 카카오 알림톡 승인 전에는 False (LMS 문자 발송) ➔ 승인 완료 후 True (알림톡 발송)로 변경!
USE_KAKAO = False

SOLAPI_PF_ID = "pf_..."          # 솔라피 카카오 발신프로필 키 (pf_로 시작)
SOLAPI_TEMPLATE_ID = "KA01TP..."  # 검수 제출한 알림톡 템플릿 ID
        ...
        if is_region_match:
            ...
            if success:
                ...
                try:
                    ...
                    print(f"    ⚠️ 로그 기록 주의 (SQL 생성 권장): {log_err}")
            else:
